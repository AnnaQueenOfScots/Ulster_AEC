...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link size="" url="file://\\Osfilesvr\Bus Dev Library\Sales Development Group\Product Management\50K_vector_2bchecked\Water\WATER_polygon_final.shp" mimeType="" format="" type="Local Area Network" name="Shapefile" description=""/>
  </links>
  <fees></fees>
