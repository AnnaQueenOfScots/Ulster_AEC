...
<qgis version="3.22.6-Bia?owie?a">
  <identifier>WATER_polygon_final</identifier>
  <parentidentifier></parentidentifier>
  <language>EN</language>
  <type>dataset</type>
  <title>WATER_polygon_final</title>
...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link type="Local Area Network" url="file://\\Osfilesvr\Bus Dev Library\Sales Development Group\Product Management\50K_vector_2bchecked\Water\WATER_polygon_final.shp" format="" name="Shapefile" mimeType="" size="" description=""/>
  </links>
  <fees></fees>
